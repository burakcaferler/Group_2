...
bounds=[[-32.768,32.768],[-10,10],[-600,600],[0,pi],[-30.30],[-4,5],[0,4],[-5.12,5.12],[-2.048,2.048],[-500,500],[-5.12,5.12],[-10,10],[-900,900],[-5,10],[-65.536, 65.536],[0,0.1],[0,0.1],[-10,10]]
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def button_clicked(self):
        ...
        for index, combo_box in enumerate(combo_boxes, start=1):
            ...
            elif combo_box.currentText() == "DO":
                self.run_algorithm(index, "DO")
            elif combo_box.currentText() == "GOA":
                self.run_algorithm(index, "GOA")
    ...
    def run_algorithm(self, algorithm_type, algorithm_name):
        ...
        if algorithm_name == "PSO" :  # PSO
            ...
            self.update_graph(algorithm_type)
        elif algorithm_name=="DO":
            if algorithm_type == 1: 
                dimension=int(self.DO_dim.text())
                pop_size=int(self.DO_popSize.text())
                iters=int(self.DO_iters.text())
            elif algorithm_type == 2:
                dimension=int(self.DO_dim_2.text())
                pop_size=int(self.DO_popSize_2.text())
                iters=int(self.DO_iters_2.text())
            else:
                dimension=int(self.DO_dim_3.text())
                pop_size=int(self.DO_popSize_3.text())
                iters=int(self.DO_iters_3.text())
                
            lower_bound = float(self.lower_bound.text())
            upper_bound = float(self.upper_bound.text())
            self.sol = DO(obj_func, lower_bound,upper_bound,dimension,pop_size,iters)
            self.update_graph(algorithm_type)
        elif algorithm_name=="GOA":
            if algorithm_type == 1:
                pop_size=int(self.GOA_popSize.text())
                iters=int(self.GOA_iters.text())
                dimension=int(self.GOA_dim.text())
                c_min=int(self.GOA_c_min.text())
                c_max=int(self.GOA_c_max.text())
            elif algorithm_type == 2:
                pop_size=int(self.GOA_popSize_2.text())
                iters=int(self.GOA_iters_2.text())
                dimension=int(self.GOA_dim_2.text())
                c_min=int(self.GOA_c_min_2.text())
                c_max=int(self.GOA_c_max_2.text())
            else:
                pop_size=int(self.GOA_popSize_3.text())
                iters=int(self.GOA_iters_3.text())
                dimension=int(self.GOA_dim_3.text())
                c_min=int(self.GOA_c_min_3.text())
                c_max=int(self.GOA_c_max_3.text())
                
            lower_bound = float(self.lower_bound.text())
            upper_bound = float(self.upper_bound.text())
            self.sol = GOA(obj_func,lower_bound,upper_bound,dimension,pop_size,iters,c_min,c_max)
            self.update_graph(algorithm_type)
    ...
    def function_select(self):
            ...
            if func==0:
                ...
                return functions.selectFunction(Functions.michalewicz)
            elif func==4:
                return functions.selectFunction(Functions.perm)
            elif func==5:
                return functions.selectFunction(Functions.powell)
            elif func==6:
                return functions.selectFunction(Functions.powersum)
            elif func==7:
                ...
                return functions.selectFunction(Functions.sum2)
            elif func==12:
                return functions.selectFunction(Functions.trid)
            elif func==13:
                return functions.selectFunction(Functions.zakharov)
            elif func==14:
                return functions.selectFunction(Functions.ellipse)
            elif func==15:
                return functions.selectFunction(Functions.nesterov)
            elif func==16:
                return functions.selectFunction(Functions.saddle)
            elif func==17:
                return functions.selectFunction(Functions.levy)
